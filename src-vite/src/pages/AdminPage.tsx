    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-semibold text-white">MediCare Clinic</h1>
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-white/70 mb-1.5">Admin Password</label>
          ...
          <div className="mt-5 p-3 bg-teal-500/10 border border-teal-500/20 rounded-lg">
            <p className="text-teal-300 text-xs text-center">Demo password: <span className="font-mono font-semibold">admin123</span></p>
          </div>
        </div>
