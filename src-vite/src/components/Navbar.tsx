      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/book" className="btn-brand text-white text-sm font-semibold px-5 py-2.5 rounded-xl">
              Book Appointment
            </Link>
          </div>

          <button onClick={() => setOpen(!open)} className="md:hidden p-2 rounded-lg text-slate-600 hover:bg-teal-50 transition-colors">
