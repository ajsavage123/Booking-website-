      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md animate-scale-in">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="font-display text-3xl font-semibold text-slate-900 mb-1">
              Booking Confirmed!
            </h1>
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
              ...
              onClick={() => {
                if (navigator.share) {
                  navigator.share({
                    ...
                    text: `I've booked a ${serviceName} on ${
                      date ? formatDate(date) : date
                    } at ${formatTime(time)} at MediCare Clinic`,
                  });
                }
              }}
            ...
            <Link
              href="/book"
              className="flex items-center justify-center gap-2 bg-teal-50 hover:bg-teal-100 text-teal-700 font-medium py-3 rounded-xl text-sm transition-colors"
            >
              Book Another
            </Link>
          </div>
          ...
          <p className="text-center text-xs text-slate-400 mt-5 leading-relaxed">
            Please send us a WhatsApp message to confirm your appointment.
            <br />
